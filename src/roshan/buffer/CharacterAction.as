package roshan.buffer {
	...
	public dynamic final class CharacterAction extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const ID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("roshan.buffer.CharacterAction.id", "id", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const X:FieldDescriptor$TYPE_SINT32 = new FieldDescriptor$TYPE_SINT32("roshan.buffer.CharacterAction.x", "x", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const Y:FieldDescriptor$TYPE_SINT32 = new FieldDescriptor$TYPE_SINT32("roshan.buffer.CharacterAction.y", "y", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const SAY:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("roshan.buffer.CharacterAction.say", "say", (4 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const WALK:FieldDescriptor$TYPE_BOOL = new FieldDescriptor$TYPE_BOOL("roshan.buffer.CharacterAction.walk", "walk", (7 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const DIRECTION:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("roshan.buffer.CharacterAction.direction", "direction", (8 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const ACTION:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("roshan.buffer.CharacterAction.action", "action", (9 << 3) | com.netease.protobuf.WireType.VARINT, roshan.buffer.ACTION);
		 ...
		 *  @private
		 */
		public static const ISYOU:FieldDescriptor$TYPE_BOOL = new FieldDescriptor$TYPE_BOOL("roshan.buffer.CharacterAction.isYou", "isYou", (11 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const GONE:FieldDescriptor$TYPE_BOOL = new FieldDescriptor$TYPE_BOOL("roshan.buffer.CharacterAction.gone", "gone", (12 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const CHARACTERTYPE:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("roshan.buffer.CharacterAction.characterType", "characterType", (13 << 3) | com.netease.protobuf.WireType.VARINT, roshan.buffer.CHARACTER_TYPE);
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			...
			if (hasX) {
				...
				com.netease.protobuf.WriteUtils.write$TYPE_SINT32(output, x$field);
			}
			if (hasY) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 3);
				com.netease.protobuf.WriteUtils.write$TYPE_SINT32(output, y$field);
			}
			if (hasSay) {
			...
			if (hasWalk) {
				...
				com.netease.protobuf.WriteUtils.write$TYPE_BOOL(output, walk$field);
			}
			if (hasDirection) {
			...
			if (hasIsYou) {
				...
				com.netease.protobuf.WriteUtils.write$TYPE_BOOL(output, isYou$field);
			}
			if (hasGone) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 12);
				com.netease.protobuf.WriteUtils.write$TYPE_BOOL(output, gone$field);
			}
			if (hasCharacterType) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 13);
				com.netease.protobuf.WriteUtils.write$TYPE_ENUM(output, characterType$field);
			}
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 2:
					...
					++x$count;
					this.x = com.netease.protobuf.ReadUtils.read$TYPE_SINT32(input);
					break;
				case 3:
					if (y$count != 0) {
					...
					++y$count;
					this.y = com.netease.protobuf.ReadUtils.read$TYPE_SINT32(input);
					break;
				case 4:
					if (say$count != 0) {
				...
				case 7:
					...
					++walk$count;
					this.walk = com.netease.protobuf.ReadUtils.read$TYPE_BOOL(input);
					break;
				case 8:
				...
				case 11:
					...
					++isYou$count;
					this.isYou = com.netease.protobuf.ReadUtils.read$TYPE_BOOL(input);
					break;
				case 12:
					if (gone$count != 0) {
					...
					++gone$count;
					this.gone = com.netease.protobuf.ReadUtils.read$TYPE_BOOL(input);
					break;
				case 13:
					...
					++characterType$count;
					this.characterType = com.netease.protobuf.ReadUtils.read$TYPE_ENUM(input);
					break;
				default:
